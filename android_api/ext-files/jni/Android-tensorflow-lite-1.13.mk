...
# Now this file is to build tensorflow-lite from nnsuite tensorflow repository with version 1.13.1.
#------------------------------------------------------
...
CORE_CC_EXCLUDE_SRCS := \
    ...
    $(wildcard $(TF_LITE_DIR)/mmap_allocation_disabled.cc) \
    $(wildcard $(TF_LITE_DIR)/nnapi_delegate_disabled.cc)
